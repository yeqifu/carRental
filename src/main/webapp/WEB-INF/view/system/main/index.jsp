        ...
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="${yeqifu}/static/images/face.jpg" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName">${user.realname}</cite></a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" data-url="${yeqifu}/static/page/user/userInfo.html"><i class="seraph icon-ziliao" data-icon="icon-ziliao"></i><cite>个人资料</cite></a></dd>
...
<script type="text/javascript">
    ...
    layui.use(['bodyTab','form','element','layer','jquery'],function(){
        ...
        tab = layui.bodyTab({
            ...
            url : "${yeqifu}/static/json/navs.json" //获取菜单json地址
        });
