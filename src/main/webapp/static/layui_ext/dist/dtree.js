layui.define(["jquery", "layer", "form"], function (e) {
    var y = layui.$, f = layui.layer, r = layui.form, m = "dtree-nav-ul-sid", k = "dtree-nav-item", S = "dtree-nav-div",
        ...
        l = "dtree-toolbar-fixed", D = "dtree-nav-checkbox-div", C = "d-click-checkbar", n = "t-click", c = "dtree",
        s = "dtree-nav-first-line", d = "dtree-nav-line", h = "dtree-nav-last-line", i = "dtree-nav-this",
        T = "dtree-nav-show", N = "dtree-nav-hide", x = "dtree-disabled", j = "dtree-icon-hide", a = y("body"),
        ...
        E = "dtree-icon-roundclosefill", F = "dtree-icon-roundcheck", _ = "dtree-icon-delete1",
        M = "dtree-icon-search_list_light", B = "dtree-icon-pulldown", U = "dtree-icon-pullup",
        H = "dtree-icon-roundadd", W = "dtree-icon-bianji", $ = "dtree-icon-roundclose", G = {
            ...
            9: "dtree-icon-set-sm",
            10: "dtree-icon-rate"
        }, J = "dtree-", z = "checkNodeClick", X = "itemNodeClick", K = "pulldown", Q = "pullup", Y = "addToolbar",
    ...
    be.prototype.setting = function (e) {
        ...
        if ("object" == typeof n) if (n.autoHeight(), n.data) {
            ...
            n.obj.html(""), setTimeout(function () {
                ...
                n.showLine(), n.toolbar && "contextmenu" != n.toolbarWay && n.setToolbarDom().setToolbarPlace(n.toolbarMenu), n.msgErrData(), n.done(n.data, n.obj)
            }, 100)
        } else {
            ...
            fe({
                ...
                success: function (e) {
                    ...
                    if ((t = "layuiStyle" == n.dataStyle ? e[n.response.statusName] : e.status[n.response.statusName]) == n.response.statusCode) {
                        ...
                        if (n.success(e, n.obj), "list" == n.dataFormat) {
                            var a = n.obj.attr("data-id"), i = n.queryListTreeByPid(a, o);
                            n.loadListTree(i, o, 1)
                        } else n.loadTree(o, 1);
                        n.showLine(), n.toolbar && "contextmenu" != n.toolbarWay && n.setToolbarDom().setToolbarPlace(n.toolbarMenu), n.msgErrData(), n.done(e, n.obj)
        ...
        if (n.setNodeParam(e), void 0 !== t) {
            ...
            n.showLine(), n.toolbar && "contextmenu" != n.toolbarWay && n.setToolbarDom().setToolbarPlace(n.toolbarMenu), n.msgErrData()
        } else {
            if (!n.url) return void f.msg("数据请求异常，url参数未指定", {icon: 5});
            s.html("");
            ...
            fe({
                ...
                success: function (e) {
                    ...
                    if ((t = "layuiStyle" == n.dataStyle ? e[n.response.statusName] : e.status[n.response.statusName]) == n.response.statusCode) {
                        ...
                        n.showLine(), n.toolbar && "contextmenu" != n.toolbarWay && n.setToolbarDom().setToolbarPlace(n.toolbarMenu), n.msgErrData(), s.addClass(T)
                    } else "layuiStyle" == n.dataStyle ? (n.obj.html(n.getNoneDom().errText(e[n.response.message])), n.error(null, t, e[n.response.message])) : (n.obj.html(n.getNoneDom().errText(e.status[n.response.message])), n.error(null, t, e.status[n.response.message]))
                },
                error: function (e, t, o) {
                    n.obj.html(n.getNoneDom().errText(t + ": " + o)), n.error(e, t, o)
            ...
            fnode: function () {
                ...
                if ("node" == f.checkbarLoad ? b && (e = !0) : l && b && (e = !0), e) {
                    ...
                    if (c && 0 < c.length) for (var o = 0; o < c.length; o++) {
                        ...
                        var s = "";
                        u && (s = x), t += "<i class='" + n + " " + f.style.dfont + " " + f.style.cbox + " " + s + "' data-id='" + r + "' dtree-id='" + p + "' data-checked='" + a.checked + "' data-initchecked='" + a.checked + "' data-type='" + a.type + "' dtree-click='" + z + "' data-par='." + C + "' dtree-disabled='" + u + "'></i>"
                    }
                    return t += "</div>"
                }
                return ""
                ...
                return l ? "<ul class='" + m + "' data-id='" + r + "' dtree-id='" + p + "'></ul>" : h ? "<ul class='" + m + " " + T + "' data-id='" + r + "' dtree-id='" + p + "'></ul>" : "<ul class='" + m + "' data-id='" + r + "' dtree-id='" + p + "'></ul>"
            }
        }
            ...
            fnode: function (e) {
                ...
                if ("node" == f.checkbarLoad ? b && (t = !0) : c && b && (t = !0), t) {
                    ...
                    if (e && 0 < e.length) for (var a = 0; a < e.length; a++) {
                        ...
                        var r = "";
                        u && (r = x), o += "<i class='" + s + " " + f.style.dfont + " " + f.style.cbox + " " + r + "' data-id='" + d + "' dtree-id='" + p + "' data-checked='" + i.checked + "' data-initchecked='" + i.checked + "' data-type='" + i.type + "' dtree-click='" + z + "' data-par='." + C + "' dtree-disabled='" + u + "'></i>"
                    }
                ...
                var e = c ? "<ul class='" + m + "' data-id='" + d + "' dtree-id='" + p + "'></ul>" : h ? "<ul class='" + m + " " + T + "' data-id='" + d + "' dtree-id='" + p + "'></ul>" : "<ul class='" + m + "' data-id='" + d + "' dtree-id='" + p + "'></ul>";
        ...
        var g = "";
        return h && (g = N), ["<li class='" + C + " " + k + " " + g + " 'data-id='" + e + "'data-pid='" + ("root" == p ? void 0 !== typeof t && "" != t ? t : "-1" : t) + "'dtree-id='" + m + "'data-index='" + l + "'dtree-hide='" + h + "'>" + v, y.fnode(), y.node(), y.checkbox(), y.text(), "</div>", y.ul(), "</li>"].join("")
        ...
        if (this.accordion) {
            e.closest("li[data-index]").siblings("li[data-index]").children("ul[data-id]").removeClass(T);
        ...
        0 < n.length && ("close" == i ? ("load" == t.type ? t.cache ? n.html() ? n.addClass(T) : t.getChild(e) : (n.html(""), t.getChild(e)) : n.addClass(T), t.accordionUL(n), t.operateIcon(o, a).open()) : "open" == i && (n.removeClass(T), t.operateIcon(o, a).close()))
        ...
        for (var t = e.split(","), o = 0; o < t.length; o++) {
            ...
            null != a && "true" != a.attr("dtree-hide") && (a.attr("dtree-hide", "true"), i.attr("dtree-hide", "true"), i.addClass(N))
        }
    }, be.prototype.cancelHideNodes = function (e) {
        for (var t = e.split(","), o = 0; o < t.length; o++) {
            var a = this.getNodeDom(t[o]).div(), i = a.parent("li[dtree-hide]");
            null != a && "true" == a.attr("dtree-hide") && (a.attr("dtree-hide", "false"), i.attr("dtree-hide", "false"), i.removeClass(N))
        }
        ...
        if ("last" == a.eq(0).attr("data-spread") ? o.operateIcon(a.eq(0), a.eq(1)).openWithLeaf() : o.operateIcon(a.eq(0), a.eq(1)).open(), $ul.addClass(T), o.accordionUL($ul), t) if (t.length && 0 < t.length) o.getChild(e, t); else {
            var i = o.parseData(t);
            if (i.treeId()) {
        ...
        if ($ul = e.next("ul"), t) if ("object" == typeof t) {
            ...
            if (a.treeId()) {
                ...
                i.node(a.iconClass()), i.checkbox(a.checkArr()), i.text(a.title()), i.ul(), i.basicData(a.basicData()), i.recordData(a.recordData()), o.setNodeParam(e)
        ...
        var t = this, o = t.temp;
        void 0 === e && (e = o[0]), "all" == t.checkbarType ? t.checkAllOrNot(e) : "no-all" == t.checkbarType ? t.checkAllOrNoallOrNot(e) : "p-casc" == t.checkbarType ? t.checkAllOrPcascOrNot(e) : "self" == t.checkbarType ? t.checkOrNot(e) : "only" == t.checkbarType ? t.checkOnly(e) : t.checkAllOrNot(e);
        var a = t.setAndGetCheckbarNodesParam();
    ...
    }, be.prototype.setAndGetCheckbarNodesParam = function () {
        var o = this;
        return o.checkbarNode = [], "change" == o.checkbarData ? o.obj.find("i[data-par][dtree-disabled='false']").each(function () {
        ...
        var o = this, a = {};
        return a.nodeId = e.attr("data-id"), a.parentId = o.getNodeDom(e).parentLi().attr("data-pid"), a.context = "function" == typeof o.formatter.title ? o.getNodeDom(e).cite().attr("data-title") : o.getNodeDom(e).cite().text(), a.leaf = "leaf" == o.getNodeDom(e).cite().attr("data-leaf"), a.level = o.getNodeDom(e).parentLi().attr("data-index"), a.spread = "open" == o.getNodeDom(e).fnode().attr("data-spread"), a.basicData = e.attr("data-basic"), a.recordData = e.attr("data-record"), a.dataType = t.attr("data-type"), a.checked = t.attr("data-checked"), a.initchecked = t.attr("data-initchecked"), a
            ...
            openAllNode: function (e) {
                for (var t = e || c.obj.children("li").children("ul"), o = 0; o < t.length; o++) {
                    ...
                    if ("leaf" != r.attr("data-leaf")) {
                        "open" == l || ("load" == c.type ? c.cache ? a.html() ? a.addClass(T) : c.getChild(i) : (a.html(""), c.getChild(i)) : a.addClass(T), c.operateIcon(n, s).open());
                ...
                c.obj.find("." + m).each(function () {
                    ...
                    e.removeClass(T), c.operateIcon(o, a).close()
                })
                ...
                if (0 == c.obj.find("i[data-par][data-checked='1']").length) f.msg("请至少选中一个节点", {icon: 2}); else {
                    c.checkbarNode = [];
                    c.obj.find("i[data-par][data-checked='1']").each(function () {
                        ...
                        c.menubarFun.remove(c.checkbarNode) && (c.obj.find("i[data-par][data-checked='1']").closest("." + S).next("ul").remove(), c.obj.find("i[data-par][data-checked='1']").closest("." + S).remove(), c.checkbarNode = []), f.close(e)
                    })
                }
            }, searchNode: function () {
        ...
        if (e) {
            ...
            "last" == c.eq(0).attr("data-spread") ? t.operateIcon(c.eq(0), c.eq(1)).openWithLeaf() : t.operateIcon(c.eq(0), c.eq(1)).open(), i.addClass(T), t.accordionUL(i), r ? t.getChild(n) : (t.showLine(i.find("li")), t.toolbar && "contextmenu" != t.toolbarWay && t.dynamicToolbarDom(l.find("cite[data-leaf]")))
        ...
        if (t.node.nodeId = e.attr("data-id"), t.node.parentId = t.getNodeDom(e).parentLi().attr("data-pid"), t.node.context = "function" == typeof t.formatter.title ? t.getNodeDom(e).cite().attr("data-title") : t.getNodeDom(e).cite().text(), t.node.leaf = "leaf" == t.getNodeDom(e).cite().attr("data-leaf"), t.node.level = t.getNodeDom(e).parentLi().attr("data-index"), t.node.spread = "open" == t.getNodeDom(e).fnode().attr("data-spread"), t.node.basicData = e.attr("data-basic"), t.node.recordData = e.attr("data-record"), t.getNodeDom(e).checkbox()) {
            ...
            t.getNodeDom(e).checkbox().each(function () {
                o += y(this).attr("data-type") + ",", a += y(this).attr("data-checked") + ",", i += y(this).attr("data-initchecked") + ","
            }), o = o.substring(0, o.length - 1), a = a.substring(0, a.length - 1), i = i.substring(0, i.length - 1), t.node.dataType = o, t.node.checked = a, t.node.initchecked = i
        }
        ...
        if (o.nodeId = e.attr("data-id"), o.parentId = t.getNodeDom(e).parentLi().attr("data-pid"), o.context = "function" == typeof t.formatter.title ? t.getNodeDom(e).cite().attr("data-title") : t.getNodeDom(e).cite().text(), o.leaf = "leaf" == t.getNodeDom(e).cite().attr("data-leaf"), o.level = t.getNodeDom(e).parentLi().attr("data-index"), o.spread = "open" == t.getNodeDom(e).fnode().attr("data-spread"), o.basicData = e.attr("data-basic"), o.recordData = e.attr("data-record"), t.getNodeDom(e).checkbox()) {
            var a = "", i = "", n = "";
            t.getNodeDom(e).checkbox().each(function () {
                a += y(this).attr("data-type") + ",", i += y(this).attr("data-checked") + ",", n += y(this).attr("data-initchecked") + ","
            }), a = a.substring(0, a.length - 1), i = i.substring(0, i.length - 1), n = n.substring(0, n.length - 1), o.dataType = a, o.checked = i, o.initchecked = n
        }
        return o
    }, be.prototype.initNodeParam = function () {
        var e = this;
        e.node.nodeId = "", e.node.parentId = "", e.node.context = "", e.node.leaf = "", e.node.level = "", e.node.spread = "", e.node.dataType = "", e.node.checked = "", e.node.initchecked = "", e.node.basicData = "", e.node.recordData = ""
        ...
        s.obj.on("click", "i[data-spread]", function (e) {
            ...
            if (s.toolbarHide(), s.navThis(t), s.select && (s.setSelectValue(o.context), y("div[dtree-id='" + i + "'][dtree-select='" + s.selectTreeDiv + "']").toggleClass("layui-form-selected"), y("div[dtree-id='" + i + "'][dtree-card='" + s.selectCardDiv + "']").toggleClass("dtree-select-show layui-anim layui-anim-upbit")), s.useIframe) {
            ...
            e.stopPropagation();
            var t = y(this), o = (t.find("cite"), s.getNodeParam(t));
            s.toolbarHide(), s.navThis(t), s.select && (s.setSelectValue(o.context), y("div[dtree-id='" + i + "'][dtree-select='" + s.selectTreeDiv + "']").toggleClass("layui-form-selected"), y("div[dtree-id='" + i + "'][dtree-card='" + s.selectCardDiv + "']").toggleClass("dtree-select-show layui-anim layui-anim-upbit")), layui.event.call(this, p, "nodedblclick(" + y(s.obj)[0].id + ")", {
                param: s.callbackData().node(o),
                childParams: s.callbackData().childNode(t),
                parentParam: s.callbackData().parentNode(t),
                dom: s.callbackData().dom(t)
            ...
            "mouseover" == e.type ? (t.removeClass(N), e.stopPropagation()) : "mouseout" == e.type && (t.addClass(N), e.stopPropagation())
            ...
            e.stopPropagation(), y(this).toggleClass("layui-form-selected"), y("div[dtree-id='" + i + "'][dtree-card='" + s.selectCardDiv + "']").toggleClass("dtree-select-show layui-anim layui-anim-upbit")
        })
    },a.on("click", function (e) {
        y("div." + t).find(".layui-show").removeClass("layui-anim-fadein layui-show"), y("div[dtree-id][dtree-card]").removeClass("dtree-select-show layui-anim layui-anim-upbit")
    }),be.prototype.unbindBrowserEvent = function () {
        var e = this;
        e.obj.unbind(), e.menubar && (e.obj.prevAll("div#dtree_menubar_" + e.obj[0].id).unbind(), 0 < e.obj.closest("body").find("*[dtree-id='" + e.obj[0].id + "'][dtree-menu]").length && e.obj.closest("body").find("*[dtree-id='" + e.obj[0].id + "'][dtree-menu]").unbind()), e.toolbar && "contextmenu" == e.toolbarWay && (e.obj.prevAll("div#dtree_toolbar_" + e.obj[0].id).unbind(), 0 < e.obj.closest(e.scroll).length && e.obj.closest(e.scroll).unbind())
    },e("dtree", {
        set: function (e) {
            void 0 !== e && y.extend(b, e)
        }, render: function (e) {
            var t = null, o = de.getElemId(e);
            return "" == o ? f.msg("页面中未找到绑定id", {icon: 5}) : ("object" == typeof(t = I[o]) ? (t.reloadSetting(e), t.initTreePlus(), t.openTreePlus(), t.initNodeParam(), t.init(), t.unbindBrowserEvent()) : (t = new be(e), (I[o] = t).initTreePlus(), t.openTreePlus(), t.init()), t.bindBrowserEvent()), t
        }, renderSelect: function (e) {
            var t = null, o = de.getElemId(e);
            return "" == o ? f.msg("页面中未找到绑定id", {icon: 5}) : ("object" == typeof(t = I[o]) ? (t.reloadSetting(e), t.selectSetting(e), t.initTreePlus(), t.openTreePlus(), t.initNodeParam(), t.init(), t.unbindBrowserEvent()) : ((t = new be(e)).selectSetting(e), (I[o] = t).initTreePlus(), t.openTreePlus(), t.init()), t.bindBrowserEvent()), t
        }, reload: function (e, t) {
            ...
            if ("string" == typeof e && (e = I[e]), void 0 !== e) return e.setSelectValue(t);
            f.msg("方法获取失败，请检查ID或对象传递是否正确", {icon: 2})
        }, escape: function (e) {
            return de.escape(e)
        }, unescape: function (e) {
